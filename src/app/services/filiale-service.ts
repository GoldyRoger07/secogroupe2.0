...
export class FilialeService {
  ...
  filialesPays: FilialePays[] = [
    ...
    new FilialePays('haïti','seco_securite'),
    new FilialePays('haïti','seco_tech'),
    new FilialePays('haïti','seco_energy_co'),
    new FilialePays('haïti','seco_agro_industries'),
    new FilialePays('haïti','seco_distributors'),
    new FilialePays('haïti','boyo_airways'),
    new FilialePays('haïti','mass_assurance'),
    new FilialePays('haïti','mass_funds'),
    new FilialePays('haïti','seco_univers_construction'),
